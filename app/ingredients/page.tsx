    ...
    <div className="min-h-screen p-8 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <Card variant="glass">
            <h2 className="text-2xl font-bold mb-6 text-gray-900">Stock & Costos</h2>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {ingredients.map((ing) => (
                    <tr key={ing.id} className="border-b border-white/5 hover:bg-white/5 transition-colors group">
                      <td className="p-3 font-medium text-gray-900">{ing.name}</td>
                      <td className="p-3 text-gray-900">{ing.unit}</td>
                      <td className="p-3 text-green-400 font-mono">${ing.cost.toFixed(2)}</td>
                  ...
                  {ingredients.length === 0 && (
                    <tr>
                      <td colSpan={4} className="p-8 text-center text-gray-900 italic">
                        No se encontraron ingredientes. Agrega uno para comenzar.
                      </td>
                    </tr>
                  )}
                </tbody>
