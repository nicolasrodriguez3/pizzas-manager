...
const variantStyles: Record<ButtonVariant, string> = {
  primary:
    "bg-linear-to-r from-purple-500 to-indigo-600 hover:from-purple-600 hover:to-indigo-700 text-white shadow-lg",
  secondary:
    "bg-gray-500/5 hover:bg-gray-500/10 text-gray-600 border border-gray-500/10",
