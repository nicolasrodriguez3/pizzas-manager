...
import { authenticate, register, RegisterState } from '@/app/actions/auth'
...
export function LoginForm() {
    ...
    return (
        <form action={dispatch} className="space-y-4">
            ...
            <div>
                <Button variant="primary" className="w-full justify-center" disabled={isPending}>
...
export function RegisterForm() {
    const [state, dispatch, isPending] = useActionState(register, initialRegisterState)
